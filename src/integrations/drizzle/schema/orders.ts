...
export const orders = pgTable("orders", {
  ...
  chilexpressServiceTypeCode: text("chilexpress_service_type_code"),
  chilexpressServiceDescription: text("chilexpress_service_description"),
  chilexpressOriginCoverageCode: text("chilexpress_origin_coverage_code"),
