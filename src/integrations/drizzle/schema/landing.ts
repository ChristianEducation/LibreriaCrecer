...
export const heroSlides = pgTable("hero_slides", {
  ...
  ctaBorderColor: text("cta_border_color"),
  // Modo "hotspot": el boton se dibuja dentro de la imagen y estas 4
  // columnas definen el rectangulo clickeable invisible (en % de la imagen).
  ctaMode: text("cta_mode").$type<HeroCtaMode>().default(HERO_CTA_MODE_DEFAULT).notNull(),
  hotspotX: integer("hotspot_x"),
...
export const aboutSections = pgTable("about_sections", {
  ...
  sectionType: text("section_type").notNull().default("story"),
  icon: text("icon"),
  linkUrl: text("link_url"),
