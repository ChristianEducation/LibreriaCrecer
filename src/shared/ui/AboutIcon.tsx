import type { AboutOfferingIcon } from "../config/about";
...
export function AboutIcon({
  ...
  name: AboutOfferingIcon;
  size?: number;
  strokeWidth?: number;
  className?: string;
}) {
  const paths: Record<AboutOfferingIcon, string> = {
    books:
    ...
    book: "M4 19.5v-15A2.5 2.5 0 0 1 6.5 2H20v15H6.5a2.5 2.5 0 0 0 0 5H20",
    heart:
      "M20.84 4.61a5.5 5.5 0 0 0-7.78 0L12 5.67l-1.06-1.06a5.5 5.5 0 0 0-7.78 7.78l1.06 1.06L12 21.23l7.78-7.78 1.06-1.06a5.5 5.5 0 0 0 0-7.78z",
    bulb: "M9 18h6 M10 22h4 M15.09 14c.18-.98.65-1.74 1.41-2.5A6 6 0 1 0 7.5 11.5c.76.76 1.23 1.52 1.41 2.5z",
    cross: "M12 2v20 M5 8h14",
    calendar:
