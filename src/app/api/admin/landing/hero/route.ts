  ...
  try {
    ...
    const payload = isMultipart
      ? {
          ...
          cta_position: getStringFromFormData(body, "cta_position"),
          cta_bg_color: getStringFromFormData(body, "cta_bg_color"),
          cta_text_color: getStringFromFormData(body, "cta_text_color"),
          cta_border_color: getStringFromFormData(body, "cta_border_color"),
          cta_mode: getStringFromFormData(body, "cta_mode"),
          hotspot_x: getNumberFromFormData(body, "hotspot_x"),
          hotspot_y: getNumberFromFormData(body, "hotspot_y"),
          hotspot_width: getNumberFromFormData(body, "hotspot_width"),
          hotspot_height: getNumberFromFormData(body, "hotspot_height"),
          mobile_hotspot_x: getNumberFromFormData(body, "mobile_hotspot_x"),
          mobile_hotspot_y: getNumberFromFormData(body, "mobile_hotspot_y"),
          mobile_hotspot_width: getNumberFromFormData(body, "mobile_hotspot_width"),
          mobile_hotspot_height: getNumberFromFormData(body, "mobile_hotspot_height"),
          show_content: getBooleanFromFormData(body, "show_content"),
          content_position: getStringFromFormData(body, "content_position"),
          content_text_color: getStringFromFormData(body, "content_text_color"),
