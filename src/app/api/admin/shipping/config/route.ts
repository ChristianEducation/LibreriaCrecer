...
const ShippingConfigSchema = z.object({
  ...
  originStreet: z.string().trim().min(1).nullable().optional(),
  originStreetNumber: z.string().trim().min(1).nullable().optional(),
  originSupplement: z.string().trim().nullable().optional(),
  senderName: z.string().trim().min(1).nullable().optional(),
  senderPhone: z.string().trim().min(1).nullable().optional(),
