...
export function AdminLoginForm({ nextPath }: AdminLoginFormProps) {
  ...
  return (
    <div>
      ...
      <form style={{ display: "flex", flexDirection: "column", gap: "1.1rem" }} onSubmit={form.handleSubmit(onSubmit)}>
        <label style={{ display: "block" }}>
          ...
          <span style={{ position: "relative", display: "block" }}>
            <input
              className={cx(
                "w-full border bg-white text-sm text-text outline-none transition-all duration-200 placeholder:text-text-light/60 focus:border-gold focus:shadow-[0_0_0_3px_rgba(200,168,48,0.12)]",
        ...
        <div style={{ display: "flex", alignItems: "center", justifyContent: "space-between" }}>
          ...
          <span style={{ fontSize: "11px", color: "var(--text-light)" }}>Acceso seguro</span>
        </div>
