  ...
  return (
    <>
      <div className="lg:sticky lg:top-[88px]">
        <button
          className="group relative mb-3 flex w-full items-center justify-center overflow-hidden rounded-[2px] bg-[#ffffff] shadow-[0_8px_40px_rgba(58,48,1,0.1)]"
          onClick={() => setIsLightboxOpen(true)}
          style={{ maxWidth: "440px", minHeight: "400px", margin: "0 auto" }}
          type="button"
        >
          {activeImage?.url ? (
            <Image
        ...
        <div className="flex flex-wrap gap-2">
          {galleryImages.map((image, index) => {
            ...
            return (
              <button
                className={cx(
                  "relative aspect-[2/3] w-16 overflow-hidden rounded-[2px] border-2 border-transparent bg-[#ffffff] opacity-55 transition-[border-color,opacity] duration-200 hover:opacity-85 shadow-sm",
