...
- Name: home.spec.ts >> Home >> carga sin errores y muestra la navbar con el logo
...
Locator: getByText('Libreria cristiana').first()
Expected: visible
Timeout: 5000ms
...
Call log:
  ...
  - waiting for getByText('Libreria cristiana').first()
