...
- Name: catalogo.spec.ts >> Catálogo /productos >> muestra el contador de resultados
- Location: tests\catalogo.spec.ts:22:7
...
Call log:
  ...
  - waiting for getByText(/productos?/)
    8 × locator resolved to <div class="hidden lg:flex justify-end mb-6 text-sm text-text-light">…</div>
