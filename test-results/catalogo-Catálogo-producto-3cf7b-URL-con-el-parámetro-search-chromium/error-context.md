...
- Name: catalogo.spec.ts >> Catálogo /productos >> búsqueda actualiza la URL con el parámetro search
- Location: tests\catalogo.spec.ts:57:7
...
Call log:
  - waiting for getByPlaceholder('Buscar...').first()
